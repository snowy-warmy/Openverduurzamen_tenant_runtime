...
export function createPrefillSession(payload) {
  ...
  const session = {
    ...
    // Parsed .epa (0-meting) model for EPA-driven tenants (e.g. Softbee). When
    // present, the full report is rendered from this measured assessment.
    epa_model: payload.epa_model || null,
